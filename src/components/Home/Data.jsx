...
export default function Data(){
    return(
        <div className="home__data">
            <h1 className="home__title">Karan S
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Passionate Developer</h3>
            <p className="home__discription">I'm creative web developer adept at creating stunning and functional websites, delivering exceptional user experiences.
            </p>
